...
public record Quindecuple<A, B, C, D, E, F, G, H, I, J, K, L, M, N, O>(
    ...
    public Optional<?> get(int index) {
        return switch (index) {
            ...
            case 13 -> Optional.of(n);
            case 14 -> Optional.of(o);
    ...
    public boolean equals(Object obj) {
        return obj instanceof Tuple tuple
                ...
                && tuple.get(13).equals(this.get(13))
                && tuple.get(14).equals(this.get(14));
    }
}
